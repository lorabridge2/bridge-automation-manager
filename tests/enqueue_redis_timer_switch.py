...
compressed_commands.append([1, 0, 2, 8])
...
compressed_commands.append([3, 0, 2, 0, 1, 1, 9])
compressed_commands.append([3, 0, 2, 1, 1, 1, 10])
compressed_commands.append([3, 0, 2, 2, 1, 1, 15])
compressed_commands.append([3, 0, 2, 3, 1, 1, 15])
